**LuminOS** is an operating system based on Linux, optimized for C# and focused on privacy and design.  
...
## LuminSDK
that's the main part of LuminOS, thats written in C# to integrate C# programs with the OS.
LuminOS itself isn't written entirely in C#, as that would be unfeasible, due to the lack of programs made for it.  
#### If you want to try LuminSDK in early versions, there's a tutorial on README.md on the official Lumin repository
### Also
